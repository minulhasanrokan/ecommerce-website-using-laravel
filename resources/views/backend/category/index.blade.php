              ...
              <tbody>
                @foreach($categories as $category)
                  <tr>
                    ...
                    <td class="center"><img style="width: 70px;" src="{{asset('/category/'.$category->category_image)}}"></td>
                    <td class="center">
                    ...
                    <td class="center">
                        ...
                        <form style="float: right; padding: 0; margin: 0;" action="{{url('/categories/'.$category->id)}}" method="post" >
                        @csrf
                        @method('DELETE')
